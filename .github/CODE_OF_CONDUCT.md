...
reported to the project maintainer, [@avram19](https://github.com/avram19), by
opening a private report through the repository's
[**Security** tab → **Report a vulnerability**](https://github.com/avram19/vector/security/advisories/new)
(private reports are not limited to security issues) or via a direct message on
